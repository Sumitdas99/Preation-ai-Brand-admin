...
export const handlers = [
  ...
  http.get("/api/v1/billing/admin/brands", () => {
    return HttpResponse.json(getMockBrandList());
  }),
  ...
  http.post("/api/v1/billing/admin/brands", async ({ request }) => {
    ...
    const newBrand = {
      ...
      subscription_status: "AWAITING_ACTIVATION" as const,
    ...
    addMockBrand(newBrand as Parameters<typeof addMockBrand>[0]);
