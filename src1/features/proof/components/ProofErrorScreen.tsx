...
export function ProofErrorScreen({ error, onRetry, runId }: Props) {
...
function errorPresentation(error: Error) {
  ...
  if (error instanceof ForbiddenError) {
    return {
      icon: Lock,
      title: "You don't have access to this proof workflow",
      description:
  ...
  if (error instanceof NotFoundError) {
    return {
      icon: Search,
      title: "Proof workflow not found",
      description:
        "This proof submission may have been completed already, or the link is incorrect.",
    };
  }
