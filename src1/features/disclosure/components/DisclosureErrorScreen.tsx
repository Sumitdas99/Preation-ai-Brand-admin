...
export function DisclosureErrorScreen({ error, onRetry, runId }: Props) {
...
function errorPresentation(error: Error) {
  ...
  if (error instanceof ForbiddenError) {
    return {
      icon: Lock,
      title: "You don't have access to this disclosure specification",
      description:
  ...
  if (error instanceof NotFoundError) {
    return {
      icon: Search,
      title: "Disclosure specification not found",
      description:
        "This specification may have been deleted or the link is incorrect.",
    };
  }
