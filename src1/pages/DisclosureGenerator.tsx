...
export default function DisclosureGenerator() {
  ...
  const isCompliant = disclosureText.length > 20;
  ...
  const handleApplyDisclosure = () => {
    toast({
      title: "Disclosure Applied",
      description: "AI disclosure has been applied to the asset.",
    });
    navigate(`/assets/${id}`);
  };
  ...
  const handlePreview = () => {
    toast({
      ...
      description: "Opening preview with disclosure overlay...",
    });
  };
