    ...
    <div className="flex h-full min-h-screen flex-col bg-background">
      {vm ? (
        <BillingDashboardHeader
          ...
          subtitleParts={vm.header.subtitleParts}
      ...
      <DevBillingPanel stateGroups={BILLING_STATE_GROUPS} />
    </div>
  );
}
...
function DashboardBody({
  ...
  return (
    <>
      ...
      {vm.paymentVariant === "ready" && vm.payment && "cardTitle" in vm.payment ? (
