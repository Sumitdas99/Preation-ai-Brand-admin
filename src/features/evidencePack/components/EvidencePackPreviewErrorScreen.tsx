...
export function EvidencePackPreviewErrorScreen({ error, onRetry }: Props) {
...
function errorPresentation(error: Error) {
  ...
  if (error instanceof ForbiddenError) {
    return {
      icon: Lock,
      title: "You don't have access to this evidence pack",
      description:
        "Ask the original Reviewer or a Legal approver in this workspace to share access.",
    };
  }
  if (error instanceof NotFoundError) {
    return {
      ...
      description:
        "This pack may not have finished generating yet, or the link is incorrect.",
    };
  }
