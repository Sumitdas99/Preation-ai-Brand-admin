...
export function LegalDashboardErrorScreen({ error, onRetry }: Props) {
...
function errorPresentation(error: Error) {
  ...
  if (error instanceof ForbiddenError) {
    return {
      ...
      description:
        "Ask a Legal approver or Workspace Admin to grant access.",
    };
  }
  if (error instanceof NotFoundError) {
    return {
      icon: Search,
      title: "Approvals queue not found",
      description:
        "This workspace may not have Legal approvals enabled yet.",
    };
  }
